                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: Epilogue; font-size: 32px;">
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('f/assets/img/logo/logo.png') }}"
                                                                            alt="" title=""
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="left" border="0"
                                                                            src="images/image-7.png" alt=""
                                                                            title=""
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 24%;max-width: 134.4px;"
                                                                            width="134.4"
                                                                            class="v-src-width v-src-max-width" />
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="color: #ff5770; font-size: 14px; line-height: 19.6px;"><strong>Admin</strong></span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    XpertgroupBD</p>
                                                            </div>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_4" style="font-family:'Open Sans',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 100px 60px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
