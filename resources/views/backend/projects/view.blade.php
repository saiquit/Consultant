            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="float-right">
                    ...
                    <button class="btn btn-primary @if ($submitted) btn-success @endif" data-toggle="modal"
                        data-target="#request_form_modal" @if ($submitted) disabled @endif>
                        @if ($submitted)
                        Sent
                        @else
                        Accept project
        ...
        <div class=" pd-0">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="card-box mb-30">
                        ...
                        <div class="list-group">
                            ...
                            <div class="list-group-item d-flex align-items-center justify-content-between">Type
                                <span class="badge badge-primary badge-pill text-capitalized">{{ ucfirst($project->type)
                                    }}</span>
                            </div>
                        ...
                        <div class="latest-post">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <h4>
                                        <a class="btn-link" target="_" href="{{ route('admin.users.show', $user) }}">{{
                                            $user->name }}</a>
                                    </h4>
                    ...
                    <div class="card-box mb-30">
                        <h5 class="pd-20 h5 mb-0">Refered Messages</h5>
                        <div class="latest-post">
                            <ul class="list-group">
