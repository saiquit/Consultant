...
@section('content')
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="pull-left">
                <h4 class="text-blue h4">Add a New Service</h4>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="@if ($errors->has('about')) form-control-danger @endif form-control" type="text"
                        name="about" value="{{ old('about') }}" placeholder="About the service">
                    @if ($errors->has('about'))
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input type="text" name="subitems" class="form-control w-100" value="" data-role="tagsinput" />
