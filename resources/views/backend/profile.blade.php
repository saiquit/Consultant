                                            ...
                                            <li class="weight-500 col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-lg" type="text"
                                                        name="full_name"
                                                        value="{{$profile->full_name ?? old('full_name')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Email</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-lg date-picker"
                                                        name='date_birth' value="{{$profile->date_birth}}" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <label>Gender</label>
                                                    <div class="d-flex">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-lg" name="district"
                                                        value="{{$profile->district ?? old('district')}}" type="text">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <textarea
                                                        class="form-control">{{$profile->address ?? old('address')}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-5">
                                                        <input type="checkbox" class="custom-control-input"
